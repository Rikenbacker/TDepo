...
int main()
{
...

	{
		...
		XmlTest( "Parsing repeated attributes.", true, doc.Error() );	// is an  error to tinyxml-2.6.2 (didn't use to be, but caused issues)
	...
	#ifndef TIXML_USE_STL
	{
		...
		TiXmlString temp;
		XmlTest( "Empty tinyxml-2.6.2 string compare equal", ( temp == "" ), true );

		TiXmlString    foo;
		TiXmlString    bar( "" );
		XmlTest( "Empty tinyxml-2.6.2 string compare equal", ( foo == bar ), true );
	}
